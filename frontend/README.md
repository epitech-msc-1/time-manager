...
This project is set up to work with Bun as the runtime & package manager. The provided scripts in `package.json` are compatible with Bun. Use the following commands from the `frontend/` folder:
